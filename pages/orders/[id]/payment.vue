            ...
            <div class="space-y-4">
              ...
              <div class="border-t border-gray-100 pt-2 space-y-3">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <span class="font-medium text-red-600">{{ formatPrice(order.balanceAmount) }}</span>
                </div>
              </div>
            </div>
          </UCard>
...
const savePayment = async () => {
  // Form validation
  if (!form.value.amount || form.value.amount <= 0 || !form.value.paymentMethod || !form.value.paymentDate) {
    useToast().add({
