      ...
      <div class="space-y-4">
        ...
        <div v-if="twoFactorEnabled" class="mt-4 p-4 bg-blue-50 rounded-lg">
          ...
          <div class="mt-4 flex items-start space-x-6">
            ...
            <div class="space-y-4">
              <div>
                <p class="text-sm font-medium text-gray-700">Enter this code in your authenticator app:</p>
                <div class="mt-1 px-3 py-2 bg-white border border-gray-300 rounded-md text-sm font-mono">
                  JBSWY3DPEHPK3PXP
                </div>
              </div>
