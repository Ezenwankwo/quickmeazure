...
variant="soft"
size="lg"
class="text-sm"> Quick Entry Form </UBadge>
    </div>
              ...
              <div v-if="item.value === 'template'">
                ...
                >
                  ...
                  <p class="text-sm text-gray-500">
                    You can create templates in your account settings.
                  </p>
                </div>

                <div v-else>
                  <p class="text-sm text-gray-600 mb-4">
                    Select a measurement template to use for this client:
                  </p>
                        ...
                        <div>
                          ...
                          <div class="flex items-center mt-1">
                            ...
                            <span class="text-xs text-gray-500"
                              >{{ template.fields?.length || 0 }} measurements</span
                            >
                          </div>
                        </div>
                        <UIcon
