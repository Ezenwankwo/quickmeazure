...
export const monthlyPlans: SubscriptionPlan[] = [
  {
    ...
    interval: 'month',
    maxClients: 50,
    features: ['Up to 50 clients', 'Up to 200 styles', 'Unlimited orders'],
  },
  {
    id: 2,
    name: 'Professional',
    ...
    maxClients: 200,
    isFeatured: true,
    features: ['Up to 200 clients', 'Unlimited styles', 'Unlimited orders'],
  },
  {
    id: 3,
    name: 'Enterprise',
    ...
    features: ['Unlimited clients', 'Unlimited styles', 'Unlimited orders', 'Team management'],
  },
]
