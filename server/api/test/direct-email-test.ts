...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    console.log('API key preview:', config.brevoApiKey ? 
    ...
    try {
      ...
      sendSmtpEmail.htmlContent = '<html><body><h1>This is a direct test email</h1><p>This email was sent directly using the Brevo API without going through our utilities.</p></body></html>';
